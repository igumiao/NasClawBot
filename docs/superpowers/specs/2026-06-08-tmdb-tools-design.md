...
- 用户输入可能存在歧义，例如"星球大战"可能指向动画、电影，电影还有多部；TMDB 搜索结果可以让 LLM 识别歧义并向用户追问澄清
...
```
用户: "帮我找星球大战"
Agent: tmdb_search(query="星球大战")
       → 多条结果：Star Wars (电影, 1977), Star Wars: The Clone Wars (动画, 2008),
          Star Wars: The Force Awakens (电影, 2015), 等等
Agent: "星球大战系列有多部作品，你想找哪一部？
        - 星球大战 (1977) — 系列首部电影
        - 星球大战：原力觉醒 (2015) — 续集三部曲首部
        - 星球大战：克隆人战争 (2008) — 动画剧集
        还是直接搜整个系列的关键词？"
```
